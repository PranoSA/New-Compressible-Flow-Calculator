...
var Diffuser = /** @class */ (function () {
    function Diffuser(area_ratio, adiabatic_effeciency, outlet_mach) {
        ...
        this.expandToArea = function (flow) {
            ...
            do {
                var ideal_flow = Flow_1["default"].MachFromARSubsonic(flow, flow.AreaRatio2 * area_ratio, actual_pressure_flow.Mach);
                ...
                area_ratio = area_ratio + (_this.area_ratio - actual_area_ratio) / 10;
